    ...
    return (
        <section className="introduction__area">
            ...
            <div className="row align-items-center">
                ...
                <div className="col-lg-4 col-xs-12 col-sm-5 wow fadeInLeft" data-wow-delay="1.6s">
            ...
            <div className="row align-items-center introduction__flex-reverse-mobile">
                <div className="col-lg-5 offset-lg-3 col-xl-4  offset-xl-4 col-xxl-3 offset-xxl-5 col-sm-6 col-md-6 offset-md-1">
                    <div className="introduction__box-contents wow fadeInLeft" data-wow-delay="1.8s">
                ...
                <div className="col-lg-3 col-xs-12 col-sm-5 introduction__mobile-flex-img wow fadeInUp" data-wow-delay="1.3s">
                    <img src="./img/introduction/study-progress.png" alt="" className="introduction__img" />
                </div>
            </div>
            <div className="row align-items-center">
                <div className="col-lg-4 offset-lg-2 col-xl-3  offset-xl-2 col-xxl-3 offset-xxl-2 col-sm-6 wow fadeInUp" data-wow-delay="1.5s">
                    <img src="./img/introduction/code-progress.png" alt="" className="introduction__img" />
                </div>
                <div className="col-lg-5 col-xs-12 col-sm-6">
                    <div className="introduction__box-contents wow fadeInLeft" data-wow-delay="1.9s">
