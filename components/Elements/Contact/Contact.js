                ...
                <div className="row">
                    <div className="col-lg-6 offset-lg-1 col-xl-5 offset-xl-2">
                        <div className="contact__form-area">
                            <h6 className="contact__form-title">Envie uma mensagem diretamente do site preechendo<br/> o formulário abaixo.</h6>
                            <Form />
                        </div>
                    </div>
                    <div className="col-lg-4 col-xl-4 contact__links-btn-wrapper">
                        <div className="contact__btn-box">
                            ...
                            <h3 className="contact__btn-box__subtitle">Entre em contato pelos links abaixo.</h3>
